...
**Critérios de Aceitação:**
  - **93 testes RSpec** no Rails: models (User, Conteudo), requests (Web + API: CRUD completo + reclassify)
  - **25 testes Pytest** no FastAPI: predição, health check, fallback Groq, normalização de categoria
